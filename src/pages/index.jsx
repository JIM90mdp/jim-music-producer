        ...
        <Layout className="pt-0 md:p-16 sm:pt-8">
          <div className="flex items-center justify-between w-full flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              <AnimatedText
                text="Musician, Composer, Producer, and Sound Designer"
                className="!text-3xl !text-left xl:!text-3xl lg:!text-center lg:!text-3xl md:!text-3xl sm:!text-3xl"
              />
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                Greetings! I'm Juan Ignacio, a jazz guitarist, musical composer,
                conservatory instructor, and sound designer from Argentina.{" "}
                <br /> Whether you're in need of music lessons, sheet music
                transcriptions, sound design, or musical composition, I'm here
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                ...
                <Link
                  href="mailto:juanimasmusic@gmail.com"
                  target="_blank"
